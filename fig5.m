%% A program that generates reservoir eigenmodes for ESNs predicting 
%% different regimes of the logistic map
%
% Note: To get figure 5(d), just change the sizes to [1000 4000 40]
%
