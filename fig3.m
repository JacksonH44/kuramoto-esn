%% A model that generates reservoir phase states for different 
%% predictions of the logistic map at different values of a
%
% Note: To get figure 3(d), just change the sizes to [1000 4000 40]
%
